...
.subject {border-bottom: 2px solid #3399ff;font-size: 20px;margin-bottom: 10px;padding-bottom: 10px;}
.subject p{margin:0;}
...
table.tblone tr:nth-child(2n+1){background:#ddd;height:30px;}
...
.footeroption{height:65px;background:#177de3;overflow:hidden;padding-top:10px;}
...
<section class ="subject">
	<p>CRUD With PDO - Templete & Database Design<span style ="float:right"><a href="index.php">Create New</a></span></p>
</section>